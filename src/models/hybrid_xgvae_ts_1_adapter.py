...
class HybridXGVAE_TS_1_Adapter(BaseModelAdapter):
    ...
    def fit(self, train_data: Datasets, valid_data: Datasets):
        ...
        X_vl, y_vl = valid_data.get_data_for_gbdt()
        ...
        components = {
            ...
            "stage2": {
                "train": {"ce": train_ce_2, "kd": train_kd_2},
                "valid": {"ce": valid_ce_2, "kd": valid_kd_2},
            },
        }
        ...
        results = {
            ...
            "loss": {
                ...
                "stage1_ce": {
                    Split.TRAIN.value: train_ce_1,
                    Split.VALID.value: valid_ce_1,
                },
                "stage1_view": {
                    Split.TRAIN.value: train_view_1,
                    Split.VALID.value: valid_view_1,
                },
                "stage1_kl": {
                    Split.TRAIN.value: train_kl_1,
                    Split.VALID.value: valid_kl_1,
                },
                "stage1_recon": {
                    Split.TRAIN.value: train_recon_1,
                    Split.VALID.value: valid_recon_1,
                },
                "stage2_total": {
                    Split.TRAIN.value: train_total_2,
                    Split.VALID.value: valid_total_2,
                },
                "stage2_ce": {
                    Split.TRAIN.value: train_ce_2,
                    Split.VALID.value: valid_ce_2,
                },
                "stage2_kd": {
                    Split.TRAIN.value: train_kd_2,
                    Split.VALID.value: valid_kd_2,
                },
                "student_eval_ce": {
